...
1. **"I dont want you to start your zip file and i just download it, i want to know the steps so i can do it by myself"**
...
2. **"Also, the console says we need to specify `type: module`, so i updated the `package.json` and changed it from `require` to `import`"**
